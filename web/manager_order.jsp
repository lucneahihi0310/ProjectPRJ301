                ...
                <div class="row px-xl-5">
                    ...
                    <div class="col-lg-12 table-responsive mb-5">
                        ...
                        <table class="table table-bordered text-center mb-0">
                            ...
                            <c:forEach items="${listOrder}" var="list" varStatus="loop">
                                <tr>
                                    <td class="align-middle">${loop.index + 1}</td>
                                    <td class="align-middle">
                                        <img src="" alt="" style="width: 50px;">
                                        ${list.getAccount_id().getCustomer_name()} 
                                    </td>
                                    <td class="align-middle">${list.getDate()}</td>
                                    <td class="align-middle">${list.getTolatlQuantity()}</td>
                                    <td class="align-middle">$${list.getTotal()}</td>
                                    <td>${list.getStatus()}</td>
                                    <td class="align-middle" style="width: 120px;">
                                        <a href="manager-order?orderID=${list.getOrder_id()}">
