                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input readonly class="form-control" type="text" placeholder="${sessionScope.username.getAccount_name()}">
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <c:forEach items="${o.item}" var="listItem">
                                <div class="d-flex justify-content-between">
                                    <p>${listItem.getProduct().getProduct_name()}</p>
                                    <p>$ ${listItem.getPrice()}</p>
                                </div>
                            </c:forEach>
