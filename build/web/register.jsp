                        ...
                        <form  action="register" method="post">
                            <div class="control-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Your Name" name="account_name"
                                       required="required" data-validation-required-message="Please enter your name account" />
                            ...
                            <div class="control-group">
                                Your Re-Password:
                                <input type="password" class="form-control" id="password" placeholder="Your Password" name="re_password"
                                       required="required" data-validation-required-message="Please enter your re-password" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                Full Name:
                                <input type="text" class="form-control" id="name" placeholder="Your Name" name="customer_name"/>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                Your Phone:
                            ...
                            <div class="control-group">
                                Your Address:
                                <input type="text" class="form-control" id="name" placeholder="Your Name" name="address" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                Your Email:
